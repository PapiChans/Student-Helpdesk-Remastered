...
// Knowledgebase Page
Route::get('user/knowledgebase', function () {
    if (Auth::check()) {
        // Check if the user is logged in
        if (Auth::user()->is_admin) {
            // If the user is an admin, redirect to admin home page
...
})->name('user/knowledgebase');

Route::get('user/view/knowledgebase', function () {
    if (Auth::check()) {
        // Check if the user is logged in
        if (Auth::user()->is_admin) {
            // If the user is an admin, redirect to admin home page
            ...
            return view('user/view-knowledgebase');
        }
    } else {
        // If the user is not authenticated, redirect to login page
        return redirect()->route('login');
    }
})->name('user/view/knowledgebase');